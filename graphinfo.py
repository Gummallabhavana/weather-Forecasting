...
def window2():
    try:
        ...
        def graphinfo():
            ...
            root1.iconify()
            root2.title()
            root2.title("Weather App/more information/graph information")
            ...
            back_image = PhotoImage(file="back.png")
            im = Button(root2, image=back_image, command=zoom1)
            im.place(x=20, y=20)



            l1 = PhotoImage(file="01d.png")
            ll1 = Label(root2, image=l1)
            ll1.place(x=20, y=50)

            root2.mainloop()

        graph_info_image = PhotoImage(file="graphinfo.png")
        btn = Button(root1, image=graph_info_image, command=graphinfo)
